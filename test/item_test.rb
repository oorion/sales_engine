...
class ItemTest < Minitest::Test
  ...
  def setup
    data = {
      id: '1',
      name: 'Item Qui Esse',
      description: 'Nihil autem sit odio inventore deleniti. Est laudantium ' +
                   'ratione distinctio laborum. Minus voluptatem nesciunt ' +
                   'assumenda dicta voluptatum porro.',
      unit_price: '75107',
      merchant_id: '1',
  ...
  def test_it_has_attributes
    ...
    assert_equal 'Nihil autem sit odio inventore deleniti. Est laudantium ' +
                 'ratione distinctio laborum. Minus voluptatem nesciunt ' +
                 'assumenda dicta voluptatum porro.', entry.description
